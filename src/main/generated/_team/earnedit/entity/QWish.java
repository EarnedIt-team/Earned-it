...
public class QWish extends EntityPathBase<Wish> {
    ...
    private static final long serialVersionUID = -1494988456L;
    ...
    public final BooleanPath isBought = createBoolean("isBought");

    public final BooleanPath isStarred = createBoolean("isStarred");
